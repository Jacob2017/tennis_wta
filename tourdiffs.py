...
for d in tourn_dates:
    ...
    player_tour_map = {**player_tour_map, **q_players, **t_players}
...
all_matches_df = pd.concat(
    [tour_matches_df, qual_matches_df], axis=0, ignore_index=True
)
...
cross_tour_matches_df = all_matches_df[
    all_matches_df["w_tour"] != all_matches_df["l_tour"]
]
